...
},{}],"src/services/api.config.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/services/user.service.ts":[function(require,module,exports) {
"use strict";
...
var api_config_1 = __importDefault(require("./api.config"));
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , fetch(api_config_1.default.server.api + RESOURCE_NAME)];
        ...
        case 4:
          e_1 = _a.sent(); // UIkit.notification(`Error: ${e.message}`);
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 4:
          e_2 = _a.sent(); // UIkit.notification(`Error: ${e.message}`);
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , fetch("" + api_config_1.default.server.api + RESOURCE_NAME + "/" + payload.id, {
            method: 'PUT',
            body: JSON.stringify(payload),
            headers: {
              'Content-Type': 'application/json'
        ...
        case 4:
          e_3 = _a.sent(); //UIkit.notification(`Error: ${e.message}`);
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , fetch("" + api_config_1.default.server.api + RESOURCE_NAME + "/" + identifier, {
            method: 'DELETE'
          })];
        ...
        case 4:
          e_4 = _a.sent(); // UIkit.notification(`Error: ${e.message}`);
...
},{"./api.config":"src/services/api.config.ts"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var uikit_1 = __importDefault(require("uikit"));

var uikit_icons_1 = __importDefault(require("uikit/dist/js/uikit-icons"));

uikit_1.default.use(uikit_icons_1.default);
...
var getUsers = function getUsers() {
  ...
  (_a = loading) === null || _a === void 0 ? void 0 : _a.classList.remove('done');
  user_service_1.default.get().then(function (data) {
    var _a;

    users = data;
    (_a = loading) === null || _a === void 0 ? void 0 : _a.classList.add('done');
    listUsers(users);
  }).catch(function () {
    var _a;
...
var deleteUser = function deleteUser(identifier) {
  var _a;

  (_a = loading) === null || _a === void 0 ? void 0 : _a.classList.remove('done');
  user_service_1.default.remove(identifier).then(function () {
    var _a;
    ...
    listUsers(users);
    (_a = loading) === null || _a === void 0 ? void 0 : _a.classList.add('done'); //UIkit.notification(`Usuario eliminado.`);
  }).catch(function (e) {
...
var updateUser = function updateUser(payload) {
  ...
  return user_service_1.default.put(payload).then(function (data) {
    var _a;

    (_a = loading) === null || _a === void 0 ? void 0 : _a.classList.add('done');
    users[users.findIndex(function (i) {
      return i.id == payload.id;
    })] = data;
    listUsers(users); // UIkit.notification(`Usuario actualizado.`);
  });
};

(_a = myForm) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', function (e) {
  e.preventDefault(); //addUser();
});
document.addEventListener('click', function (e) {
  var _a, _b, _c;

  if ((_c = (_b = (_a = e) === null || _a === void 0 ? void 0 : _a.target) === null || _b === void 0 ? void 0 : _b.classList) === null || _c === void 0 ? void 0 : _c.contains('--delete')) {
    deleteUser(e.target.getAttribute("ref"));
  }

  if (e.target.classList.contains('--status')) {
    var user = users.find(function (i) {
      return i.id == e.target.getAttribute("ref");
    });
  ...
  if (e.target.classList.contains('--save')) {
    var user = {};
    var elements_3 = e.target.parentElement.parentElement.children;

    for (var _d = 0, elements_2 = elements_3; _d < elements_2.length; _d++) {
      var field = elements_2[_d];
    ...
    updateUser(user).then(function () {
      for (var _i = 0, elements_4 = elements_3; _i < elements_4.length; _i++) {
        var field = elements_4[_i];
...
getUsers();
},{"uikit":"node_modules/uikit/dist/js/uikit.js","uikit/dist/js/uikit-icons":"node_modules/uikit/dist/js/uikit-icons.js","./services/user.service":"src/services/user.service.ts","./assets/scss/main.scss":"src/assets/scss/main.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
